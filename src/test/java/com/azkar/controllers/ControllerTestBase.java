...
public abstract class ControllerTestBase {
  ...
  protected ResultActions preparePostRequest(String path, String body) throws Exception {
    assertThat(currentUserToken, notNullValue());
  ...
  protected ResultActions preparePutRequest(String path, String body) throws Exception {
    assertThat(currentUserToken, notNullValue());
  ...
  protected ResultActions prepareDeleteRequest(String path) throws Exception {
    assertThat(currentUserToken, notNullValue());
